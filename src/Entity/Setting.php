...
class Setting
{
    ...
    public function getEmtppassword(): ?string
    {
        return $this->emtppassword;
    }

    public function setEmtppassword(?string $emtppassword): self
    {
        $this->emtppassword = $emtppassword;
